...
setup(
  name = 'funbeav',         # How you named your package folder (MyLib)
  packages = ['funbeav'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/sidorov97/funbeav/archive/refs/tags/v01.tar.gz',    # I explain this later on
